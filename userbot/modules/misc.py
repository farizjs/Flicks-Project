...
async def reedme(e):
    await e.edit(
        ...
        "\n[WeebProject's README.md file](https://github.com/fjgaming212/Flicks-Project/blob/main/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit("Flicks Project Userbot Repo\n• Click here [Repo](https://github.com/fjgaming212/Flicks-Project)")
